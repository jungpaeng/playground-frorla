  ...
  return (
    <div className="App">
      ...
      <section>
        ...
        <ol>
          <li>
            <span style={{ backgroundColor: 'orange' }}>fullscreen [전체 화면]</span>
          </li>
          <li>
            <span style={{ backgroundColor: 'orange' }}>bold [굵게]</span>
          </li>
          <li>
            <span style={{ backgroundColor: 'orange' }}>italic [기울이기]</span>
          </li>
          <li>
            <span style={{ backgroundColor: 'orange' }}>underline [글씨 밑줄]</span>
          </li>
          <li>
            <span style={{ backgroundColor: 'orange' }}>strikeThrough [취소선]</span>
          </li>
          <li>subscript [아래 첨자]</li>
          <li>superscript [위 첨자]</li>

          <li>
            <span style={{ backgroundColor: 'orange' }}>fontFamily [글꼴]</span>
          </li>
          <li>
            <span style={{ backgroundColor: 'orange' }}>fontSize [글씨 크기]</span>
          </li>
          <li>
            <span style={{ backgroundColor: 'orange' }}>color [색상]</span>
          </li>
          ...
          <li>
            <span style={{ backgroundColor: 'orange' }}>align [정렬]</span>
          </li>
          ...
          <li>
            <span style={{ backgroundColor: 'orange' }}>insertLink [링크 연결]</span>
          </li>
          <li>
            <span style={{ backgroundColor: 'orange' }}>insertImage [이미지 추가]</span>
          </li>
          <li>
            <span style={{ backgroundColor: 'orange' }}>insertVideo [비디오 추가]</span>
          </li>
          <li>
            <span style={{ backgroundColor: 'orange' }}>insertFile [파일 추가]</span>
          </li>
          ...
          <li>
            <span style={{ backgroundColor: 'orange' }}>selectAll [본문 전체 선택]</span>
          </li>
